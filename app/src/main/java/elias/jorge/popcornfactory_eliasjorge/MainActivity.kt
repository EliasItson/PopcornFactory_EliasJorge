...
class MainActivity : AppCompatActivity() {
    ...
    class MovieAdapter: BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            var view = inflater.inflate(R.layout.movie_view, null)

            val imageViewMovieIconImage = view.findViewById<ImageView>(R.id.imageViewMovieIconImage)
            val textViewMovieIconName = view.findViewById<TextView>(R.id.textViewMovieIconName)

            imageViewMovieIconImage.setImageResource(movie.image)
            textViewMovieIconName.text = movie.title

            imageViewMovieIconImage.setOnClickListener {
